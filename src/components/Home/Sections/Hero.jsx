...
export default function Hero() {
  ...
  return (
    <div className="text-[#F3F3F3] bg-black/60 px-4 sm:px-8 md:px-12 lg:px-16 w-full mx-auto flex flex-col justify-center min-h-[60vh] sm:min-h-[70vh] md:h-full absolute top-0 left-0 right-0" >
      <TsParticles />
      <div className="max-w-7xl flex justify-center w-full mx-auto text-left z-40">
        <div className="w-fit flex flex-col items-center justify-center">
          <h1 className="text-xl sm:text-2xl md:text-5xl lg:text-6xl font-semibold text-center">
            We're <span className="">JVAI</span>-
          </h1>
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-[100px] font-bold mt-1 sm:mt-2 mb-4 sm:mb-6 text-center">
            <span className="text-blue-500">Empowering</span>
            <br />
            Innovation with AI
          </h1>
          <p className="text-sm sm:text-base md:text-xl font-light mb-4 sm:mb-6 max-w-xl text-center">
