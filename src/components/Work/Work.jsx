  ...
  return (
    <div className="w-full overflow-x-hidden">
      ...
      <div className="w-full min-h-[40vh] sm:min-h-[50vh] md:min-h-[60vh] lg:h-[80vh] bg-radial from-blue-900 via-blue-950 to-black bg-bottom">
        <div className="w-full min-h-[40vh] h-[80vh] md:h-auto sm:min-h-[50vh] md:min-h-[60vh] lg:h-[80vh] px-2 sm:px-4 md:px-8 lg:px-40 flex items-center justify-center bg-[url(/work.svg)] bg-no-repeat bg-cover bg-center">
